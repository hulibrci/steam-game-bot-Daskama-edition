...
exports.updatePersona = (total, csgo, tf, gems) => {
	client.gamesPlayed("« " + total + " games | " + tf + " TF2 | " + gems + " GEMS" + " »");
...
client.on('friendRelationship', (sid, relationship) => {
	...
	if(relationship == SteamUser.EFriendRelationship.Friend) {
	    Log.Debug("New potencial customer !" + sid);
		exports.message(sid, "Hello , welcome to Daskama Game shop bot.\n Please use !help to get a list of commands.\n( All game have a Trade Card) . We also have a Card Bot ");
